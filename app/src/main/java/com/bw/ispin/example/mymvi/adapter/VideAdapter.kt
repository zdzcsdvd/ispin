...
import com.bw.ispin.databinding.Item2Binding
import com.bw.ispin.example.mymvi.entity.VideoData

class VideAdapter(val context:Context, var data:List<VideoData>, val clickListener: ClickListener):RecyclerView.Adapter<VideAdapter.MyViewHolder1>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder1{
        binding = Item2Binding.inflate(LayoutInflater.from(context),parent,false)
        return MyViewHolder1(binding.root)
    }
